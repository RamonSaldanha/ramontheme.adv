...
$jscomp.polyfill = function (b, f, c, q) {
    if (f) {
        ...
        q = c[b];
        f = f(q);
        f != q && null != f && $jscomp.defineProperty(c, b, { configurable: !0, writable: !0, value: f });
    }
};
$jscomp.polyfill(
    "Array.from",
    function (b) {
        return b
            ...
            : function (b, c, q) {
                  ...
                  } else for (p = b.length, u = 0; u < p; u++) f.push(c.call(q, b[u], u));
                  return f;
              };
    },
    "es6",
...
$jscomp.findInternal = function (b, f, c) {
    ...
    for (var q = b.length, l = 0; l < q; l++) {
        var p = b[l];
        if (f.call(c, p, l, b)) return { i: l, v: p };
    }
    return { i: -1, v: void 0 };
};
$jscomp.polyfill(
    ...
    function (b) {
        return b
            ...
            : function (b, c) {
                  ...
                  for (var u = 0; u < p && c < l; ) if (f[c++] != b[u++]) return !1;
                  return u >= p;
              };
    },
    "es6",
...
(function () {
    ...
    function p(a) {
        (function d() {
            0 > (a.style.opacity -= 0.1) ? (a.style.display = "none") : requestAnimationFrame(d);
        })();
    }
    function u(a) {
        ...
        (function d() {
            ...
            1 < (b += 0.1) || ((a.style.opacity = b), requestAnimationFrame(d));
        })();
    }
    function w(a) {
        var b = [],
    ...
    l(function () {
                    ...
                    if (d && (/youtu\.?be/g.test(d[3]) || /vimeo/g.test(d[3])))
                        if (d && /youtu\.?be/g.test(d[3])) {
                            ...
                            h.onload = function () {
                                ...
                                x = x > r ? x : r;
                                e / x != f && (e = x * f);
                                f = new YouTubePlayer(b, { height: e, width: x, modestbranding: !0, autoplay: !0, controls: !1, origin: "*", iv_load_policy: !1, keyboard: !1, captions: !1, annotations: !1, related: !1 });
                            ...
                            if (d && /vimeo/g.test(d[3])) {
                                ...
                                a.childNodes[1].before(m);
                                b = new Vimeo.Player(m, { id: b, loop: !0, background: !0, responsive: !0, autoplay: !0, byline: !1, title: !1, muted: !0 });
        ...
        if (t)
            e(document).on("add.cards changeParameter.cards", function (d) {
        ...
        if ("undefined" !== typeof jarallax && !w()) {
            ...
            if (n) {
                ...
                e(document).on("changeParameter.cards", function (a, b, d, c) {
                    if ("bg" === b)
                        switch (((b = a.target), jarallax && jarallax(b, "destroy"), (b.style.position = ""), e(a.target).find(".mbr-background-video-preview").remove(), e(a.target).find(".mbr-background-video").remove(), c)) {
                            case "type":
        ...
        window.addEventListener("scroll", function () {
            ...
            if (r) {
                ...
                b
                    ? d != r.fixed &&
                      (l
                          ? ((r.fixed = d), r.elm.classList.toggle("is-fixed"))
        ...
        if (t)
            e(document).on("add.cards delete.cards", function (a) {
                k && clearTimeout(k);
                k = setTimeout(function () {
                    r && ((r.fixed = !1), r.elm.classList.remove("is-fixed"));
                    var a = document.querySelector(".mbr-fixed-top");
                    a && ((r = { breakPoint: f(a).top + 3 * c(a), fixed: !1, elm: a }), a.dispatchEvent(new CustomEvent("scroll")));
                }, 650);
            });
        window.smartresize(function () {
        ...
        if (n)
            e(document).on("changeParameter.cards", function (a, b, c, h) {
                if ("bg" === b)
                    switch (h) {
                        case "type":
                        ...
                        do
                            if (b.hash) {
                                ...
                                document.querySelector(d ? "body" : b.hash).forEach(function (d) {
                                    ...
                                    d.classList.contains("panel-collapse") || d.classList.contains("tab-pane") || window.scrollTo({ top: h, left: 0, behavior: "smooth" });
                                });
                                break;
                            }
    ...
    document.querySelectorAll("nav.navbar").length &&
        ((v = c(document.querySelector("nav.navbar"))), document.querySelector(".mbr-after-navbar.mbr-fullscreen") && (document.querySelector(".mbr-after-navbar.mbr-fullscreen").style.paddingTop = v + "px"));
    ...
    l(function () {
        if (!n) {
            ...
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function (a) {
                ...
                var d = b.match(/(http:\/\/|https:\/\/|)?(player.|www.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com))\/(video\/|embed\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(&\S+)?/);
                -1 !== b.indexOf("youtu")
                    ? a.setAttribute("src", "https://youtube.com/embed/" + d[6] + "?rel=0&enablejsapi=1")
                    : -1 !== b.indexOf("vimeo") && a.setAttribute("src", "https://player.vimeo.com/video/" + d[6] + "?autoplay=0&loop=0");
            });
            ...
            document.querySelectorAll('.accordionStyles > .card > .card-header > a[role="button"]').forEach(function (a) {
                a.addEventListener("click", function () {
                    ...
                    !d.classList.contains("collapsing") ||
                        ...
                        (a.classList.contains("collapsed") ? (c.classList.remove("mbri-arrow-up"), c.classList.add("mbri-arrow-down")) : (c.classList.remove("mbri-arrow-down"), c.classList.add("mbri-arrow-up")),
                        -1 != b.indexOf("accordion") &&
                            ((b = a.closest(".accordionStyles")),
                            Array.from(b.children)
                                .filter(function (a) {
                                    return a.querySelector("span.sign") !== c;
                                })
                                .forEach(function (a) {
    ...
    if (n) {
        if (!t) return;
        e(document).on("add.cards", function (a) {
            e(a.target).find(".form-with-styler").length &&
                ((a = e(a.target).find(".form-with-styler")),
                e(a)
    ...
    if (n)
        e(document).on("add.cards changeParameter.cards", function (a, b) {
...
!(function () {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Simple Creator</a> Mobirise v5.6.0';
